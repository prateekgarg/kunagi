...
public class ScreenCssBuilder implements CssBuilder {
	...
	public void buildCss(CssRenderer css) {
		...
		css.style(".ARichtextViewEditWidget-viewer code.codeBlock").padding(5).margin(0, 10, 10, 10).border(1, "#EEE")
				.background(Colors.lighten(cFieldBackground)).maxWidth(350).maxHeight(400).overflowScroll();
