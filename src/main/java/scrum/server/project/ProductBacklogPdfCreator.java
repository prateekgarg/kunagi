...
public class ProductBacklogPdfCreator extends APdfCreator {
	...
	protected void build(APdfContainerElement pdf) {
		...
		fields.field("Product Owner").text(project.getProductOwnersAsString());
		fields.field("Scrum Master").text(project.getScrumMastersAsString());
		fields.field("Team").text(project.getTeamMembersAsString());
	...
	protected String getFilename() {
		return "kunagi-productbacklog_" + Date.today().toString() + "_"
