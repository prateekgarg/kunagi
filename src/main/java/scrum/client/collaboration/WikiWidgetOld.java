...
public class WikiWidgetOld extends AScrumWidget {
	...
	protected Widget onInitialization() {
		...
		if (editor != null && editor.isEditMode()) return panel;
		if (commentsWidget != null && commentsWidget.isEditorActive()) return panel;
		...
		if (wikipage == null) {
			...
			page.addSection(new ButtonWidget(new CreateWikipageAction()));
		} else {
