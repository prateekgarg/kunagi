...
public class ReleaseManagementWidget extends AScrumWidget {
	...
	protected Widget onInitialization() {
		...
		page.addSection(ScrumGwt.createPdfLink("Download as PDF", "releasePlan", getCurrentProject()));
		page.addHeader("Published releases");
		page.addSection(published);
		page.addSection(ScrumGwt.createPdfLink("Download as PDF", "releaseHistory", getCurrentProject()));
