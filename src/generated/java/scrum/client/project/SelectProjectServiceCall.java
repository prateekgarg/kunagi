...
public class SelectProjectServiceCall
    ...
    public SelectProjectServiceCall(java.lang.String projectId) {
    ...
    protected void onExecute(int conversationNumber, com.google.gwt.user.client.rpc.AsyncCallback<scrum.client.DataTransferObject> callback) {
        ...
        service.selectProject(conversationNumber, projectId, callback);
    }
