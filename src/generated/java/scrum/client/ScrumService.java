...
public interface ScrumService extends com.google.gwt.user.client.rpc.RemoteService {
    ...
    scrum.client.DataTransferObject changeProperties(int conversationNumber, String entityId, java.util.Map<String, String> properties);
    ...
    scrum.client.DataTransferObject deleteStory(int conversationNumber, String storyId);

    scrum.client.DataTransferObject moveRequirementToProject(int conversationNumber, String destinationProjectId, String requirementId);
    ...
    scrum.client.DataTransferObject createIssueFromTask(int conversationNumber, String taskId);
