...
public class RequestChangesServiceCall
    ...
    public RequestChangesServiceCall(java.lang.String parentId) {
    ...
    protected synchronized void onExecute(int conversationNumber, com.google.gwt.user.client.rpc.AsyncCallback<scrum.client.DataTransferObject> callback) {
        ...
        service.requestChanges(conversationNumber, parentId, callback);
    }
