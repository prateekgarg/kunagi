...
public interface ScrumServiceAsync {
    ...
    void moveRequirementToProject(int conversationNumber, String projectId, String requirementId, com.google.gwt.user.client.rpc.AsyncCallback<scrum.client.DataTransferObject> callback);
